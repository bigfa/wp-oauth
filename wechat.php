...
function wechat_oauth_url(){
    ...
    $appkey = '';
    $url = 'https://open.weixin.qq.com/connect/qrconnect?appid='. WX_APPID .'&redirect_uri='. urlencode (home_url('/type=wechat')) .'&response_type=code&scope=snsapi_login&state=' . $_SESSION ['state'] . '#wechat_redirect'
	return $url;
}